...
function GamePlayViewContent({ config, navigate }) {
    ...
    }, [abortCurrentGame, logout, navigate, setAborted, setIsPaused, isOnline]);
                ...
                {showRoomClosedPopup ? (
                    <div style={{ marginTop: 12 }}>
                        <Alert variant="destructive">
                            <AlertDescription>
                                {roomClosedMessage || "Room closed by admin."}
                            </AlertDescription>
                        </Alert>
                    </div>
                ) : null}
