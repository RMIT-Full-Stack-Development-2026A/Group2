      ...
      errors: [
        {
          ...
          example: "Try signing in, or register with a different email like friend@gmail.com",
        },
      ],
    });
  }
    ...
    throw new AppError(
      "Invalid email/username or password. Check spelling and try again.",
      {
        ...
        errors: [
          {
            field: "identifier",
            message: "No matching account found, or the password is wrong.",
            example: "Example: sign in with your username (player_one) or email (you@example.com).",
          },
        ],
      },
    );
        ...
        errors: [
          {
            ...
            example: "Example: use an active player account or ask an admin to reactivate your profile.",
          },
        ],
      },
    );
        ...
        errors: [
          {
            ...
            example: "Example: MyP@ssw0rd — 8+ characters, 1 uppercase, 1 number, 1 special character.",
          },
        ],
      },
    );
...
async function refresh(refreshToken) {
  ...
  return tokenUtils.generateAccessToken(String(user._id), user.role);
}
